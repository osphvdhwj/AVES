...
/// Enhanced GridSelectionGestureDetector with OCR awareness
/// Prevents selection gesture from interfering with OCR in full-screen viewer
class GridSelectionGestureDetectorOCRAware<T> extends StatefulWidget {
  ...
  final Widget child;
  final bool isInViewerMode;

  const GridSelectionGestureDetectorOCRAware({
    super.key,
  ...
  @override
  State<GridSelectionGestureDetectorOCRAware<T>> createState() => _GridSelectionGestureDetectorOCRAwareState<T>();
}

class _GridSelectionGestureDetectorOCRAwareState<T> extends State<GridSelectionGestureDetectorOCRAware<T>> {
  ...
  @override
  void didUpdateWidget(covariant GridSelectionGestureDetectorOCRAware<T> oldWidget) {
  ...
  void _registerWidget(GridSelectionGestureDetectorOCRAware<T> widget) {
    widget.scrollController.addListener(_onScrollChanged);
  }

  void _unregisterWidget(GridSelectionGestureDetectorOCRAware<T> widget) {
    widget.scrollController.removeListener(_onScrollChanged);
  }

  @override
  Widget build(BuildContext context) {
    final selectable = widget.selectable && !widget.isInViewerMode;
